...
@RestController
@RequestMapping("/api/recipebook-kafka")
public class RecipebookKafkaResource {
    private final Logger log = LoggerFactory.getLogger(RecipebookKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RecipebookKafkaResource(KafkaProperties kafkaProperties) {
